...
check:
	qlot exec ros -s lisp-chat/tests -e '(asdf:test-system :lisp-chat/tests)'

docker-check: docker-build
	docker run --rm --entrypoint=ros $(DOCKER_IMG) -s lisp-chat/tests -e '(asdf:test-system :lisp-chat/tests)'
